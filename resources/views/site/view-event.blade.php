          ...
          <div class="justify-content-center" style="text-align: center;">
          	<div><?php $c = new Carbon\Carbon( new DateTime($event->due_date));
                ...
                ?>
                 ...
                 <strong class="text-primary">@lang('home.date'): <span class="text-info">{{$formatted}}</span></strong></div>
          	<div><strong class="text-primary">@lang('home.location'): <span class="text-info"><?php echo $event->{'location_'.$locale};?></span></strong></div>
