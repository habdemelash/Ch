         ...
         <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
               <ul>
                  ...
                  <li><a class="nav-link scrollto {{Request::is('lets-help') ? 'active' : ''}} " href="{{route('site.letshlep')}}">@lang('home.letshelp_nav')<i class="bi-calendar-event-fill"></i></a></li>
                  <li class="dropdown">
                     <a class="nav nav-link  {{Request::is('all-my-events') ? 'active' : ''}}" href="{{route('all.my.events')}}"><span>@lang('home.my_events_nav')
                     @if(Auth::check())
                     ...
                     <ul >
                        ...
                        @endfor
                        @if($myevents>3)
                        <a href="{{route('all.my.events')}}" style="text-decoration: none;" class="text-primary">@lang('home.see_all')</a>
                        @endif            
                     </ul>
                  </li>
                  <li class="dropdown">
                     <a href="#"><span>@lang('home.more')<i class="bi-plus-circle-fill font-weight-bold"></i></span> <i class="bi bi-chevron-down"></i></a>
                     <ul>
