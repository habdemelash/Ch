...
<div class="row d-flex justify-content-center">
   ...
   <div class="col-md-6">
      <strong class="mx-2"><a href="{{route('admin.helpmes')}}"><i class="bx bx-arrow-back"></i> @lang('home.back')</a> @lang('home.to_the_list')</strong>
      <h1 class="h3 mb-3"><strong>@lang('home.app_sent_from')<span class="text-info">{{$helpme->phone}}</span></strong></h1>
   </div>
   <div class="col-md-6 text-center"><span class="badge bg-info">@lang('home.status'):</span><span class="fw-bold">@lang('home.'.strtolower($helpme->status))</span>
      @if($helpme->status == 'Pending')
      <a href="{{url('dash/helpmes/accept',$helpme->id)}}" class="btn-success btn-sm mx-1 act"><i class="bx bxs-check-circle"></i> @lang('home.accept')</a>
      <a href="{{url('dash/helpmes/reject',$helpme->id)}}" class="btn-sm btn-danger mx-1 act"><i class="bx bxs-shield-x"></i> @lang('home.reject')</a>
      @elseif($helpme->status == 'Accepted')
      <a href="{{url('dash/helpmes/reject',$helpme->id)}}" class="btn-sm btn-danger mx-1 act"><i class="bx bxs-shield-x"></i> @lang('home.re_reject')</a>
      @elseif($helpme->status == 'Rejected')
      <a href="{{url('dash/helpmes/accept',$helpme->id)}}" class="btn-success btn-sm mx-1 act"><i class="bx bxs-check-circle"></i> @lang('home.re_accept')</a>
      @endif
      <a href="{{url('dash/helpmes/remove',$helpme->id)}}" class="btn-sm btn-danger mx-1 act"><i class="bx bxs-trash"></i> @lang('home.remove')</a>
   </div>
</div>
      ...
      <div class="row d-flex justify-content-center">
         ...
         <div class="col-md-4">
            <a href="{{asset('uploads/helpme-pictures')}}/{{$doc->document}}" class="img-gal">
               <div><img src="{{asset('uploads/helpme-pictures')}}/{{$doc->document}}" alt="" class="img-fluid"></div>
            </a>
         </div>
         @endforeach
      </div>
      <div class="my-2">
         <a href="{{url('dash/helpmes/improve',$helpme->id)}}" class="btn-sm btn-primary fw-bold" style="margin-top: 10px"><i class="bx bxs-edit"></i> @lang('home.improve')</a>
      </div>
   </div>
</div>
