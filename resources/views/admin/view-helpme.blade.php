...
<div class="row d-flex justify-content-center">
	...
	<div class="col-md-6">
		<strong class="mx-2"><a href="{{route('admin.helpmes')}}"><i class="bx bx-arrow-back"></i> @lang('home.back')</a> @lang('home.to_the_list')</strong><h1 class="h3 mb-3"><strong>@lang('home.app_sent_from')<span class="text-info">{{$helpme->phone}}</span></strong></h1></div>
