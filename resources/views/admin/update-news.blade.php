   ...
   <form action="{{ url('dash/news/update',$news->id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row d-flex justify-content-start">
         ...
         <div class=" mb-3 col-md-4 my-1">
            ...
            <input type="text" class="form-control" name="{{'heading_'.$locale}}" value="<?php echo $news->{'heading_'.$locale}; ?>">
         </div>
         ...
         <div class="col-md-8 my-1 justify-content-start mx-1 d-flex flex-wrap my-1">
            ...
            <img src="{{asset('uploads/news-pictures')}}/{{$news->picture}}" alt="" class="img-thumbnail" width="200" height="200" id="output_image">
         </div>
      </div>
</div>
