	...
	<div class="container">
                    	...
                    	<table class="table table-hover my-0 table-responsive" id="eventsTable">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-info fw-bold" style="font-family: Times New Roman;"> @if($helpme->seen==0) <span class="badge bg-danger">@lang('home.new')</span><br> @endif <?php echo $helpme->{'problem_title_'.$locale}; ?></td>
      ...
      ;
											...
											<td>@if($helpme->status == 'Pending')
												...
												<a href="{{url('dash/helpmes/view',$helpme->id)}}" class="my-1 text-success fw-bold">@lang('home.review')</a>
											
												<a href="{{url('dash/helpmes/improve',$helpme->id)}}" class="my-1 text-info fw-bold">@lang('home.improve')</a>
												<a href="{{url('dash/helpmes/remove',$helpme->id)}}" class="my-1 text-danger fw-bold">@lang('home.remove')</a>
