...
<div class=" mb-3 col-md-4 my-1">
  ...
  <input type="text" class="form-control" name="{{'title_'.$locale}}" value="<?php echo $event->{'title_'.$locale}; ?>">
...
<div class=" my-1 col-md-8">
  ...
  <textarea class="form-control"  name="{{'details_'.$locale}}" style="height: 100px;"><?php echo $event->{'title_'.$locale}; ?></textarea>
