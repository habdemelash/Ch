        ...
        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
          ...
          <form action="{{ route('register') }}" method="post" role="form" class="php-email-form">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6 mt-3 mt-md-0">
                <label for="password-confirmation"><i class="bx bxs-lock text-danger"></i>@lang('home.confirm_password')</label>
                <input type="password" class="form-control" name="password_confirmation" id="password-confirmation" required>
              </div>
            </div>
            
           
            <div class="row mx-1"><button class="col-sm-6" type="submit">@lang('home.join_us_now')</button><a class="col-sm-6 mt-1" href="/login">@lang('home.already_joined')</a>
            </div>
          </form>
        </div>
