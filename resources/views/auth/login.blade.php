      ...
      <div class="container">
        ...
        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
          <form action="{{ route('login') }}" method="POST" role="form" class="php-email-form">
            ...
            <div class="text-center"><button type="submit"><i class="bx bx-lock-open text-white mx-1"></i>@lang('home.login')</button> <a href="{{ route('password.request') }}" class="text-primary fw-bold mx-1">@lang('home.forgot_password')</a></div>
            <div><span class="text-info">@lang('home.if_you_havent_joined')</span><strong><a href="{{route('joinus')}}">@lang('home.here')</a> </strong> <span class="text-info"> @lang('home.please')</span> </div>
          </form>
        </div>
